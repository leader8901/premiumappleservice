"""
Django premiumappleservices for premiumappleservices project.
...
For the full list of premiumappleservices and their values, see
...
ROOT_URLCONF = 'premiumappleservices.urls'
