"""
Django premiumappleservice for premiumappleservice project.
...
For the full list of premiumappleservice and their values, see
...
# Quick-start development premiumappleservice - unsuitable for production
...
ROOT_URLCONF = 'premiumappleservice.urls'
...
WSGI_APPLICATION = 'premiumappleservice.wsgi.application'
