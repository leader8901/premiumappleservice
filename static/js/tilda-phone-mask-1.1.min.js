...
function t_siblings(n, e) {
    return n.parentNode ? Array.prototype.filter.call(n.parentNode.children, function (n) {
...
function t_form_phonemask_load(n) {
    var e, t, a;
    void 0 !== n.getAttribute && (n instanceof Element || (n = n[0]), e = n.getAttribute("data-phonemask-id"), t = n.getAttribute("data-phonemask-lid"), a = n.getAttribute("data-phonemask-maskcountry") || "", n.setAttribute("data-phonemask-init", "yes"), setTimeout(function () {
        try {
            t_form_phonemask_init(e, t, a)
        } catch (n) {
            console.log(n)
        }
    }, 1e3))
...
function t_form_phonemask__getDrawSelector(n) {
    var e, t = "";
    for (e in t += "<noindex>", n) t += '<div class="t-input-phonemask__options-item" id="t-phonemask_' + e + '" data-phonemask-name="' + n[e].n + '" data-phonemask-mask="' + n[e].m + '" data-phonemask-country-code="' + e + '" data-phonemask-code="' + n[e].c + '">', t += '<div class="t-input-phonemask__options-name">' + n[e].n + "</div>", t += '<span class="t-input-phonemask__options-code">' + n[e].c + "</span>", t += '<span class="t-input-phonemask__options-flag t-input-phonemask__options-flag_' + e + '"></span>', t += "</div>";
    return t += "</noindex>"
}

function t_form_phonemask__initSelectEvents(n, t, i) {
    var a = n.querySelectorAll(".t-cover, .t396__artboard"), p = t.querySelector(".t-input-phonemask"),
        e = t.querySelector(".t-input-phonemask__select"), o = t.querySelector(".t-input-phonemask__options-wrap"),
        n = t.querySelectorAll(".t-input-phonemask__options-item"), s = "", m = "";
    ...
    function c() {
        t_form_phonemask__chooseCountry(t, this), t_form_phonemask__calcMaxlength(p), r(), 1 === a.length && (a[0].style.overflow = "")
    }
    ...
    function l(n) {
        ...
        if (e) {
            var t = /[-[\]/{}()*+?.\\^$|]/g, a = e.querySelector(".t-input-phonemask__options-item_chosen"), p = [];
            if (a && a.classList.remove("t-input-phonemask__options-item_chosen"), 48 <= n.keyCode && n.keyCode <= 57 || 96 <= n.keyCode && n.keyCode <= 105) for (var o in s = (s += n.key).replace(t, "\\$&"), i) t_form_phonemask__searchCountry(e, s, p, o, i[o].c); else if (65 <= n.keyCode && n.keyCode <= 90 || 32 == n.keyCode) for (var o in s = (s += n.key).replace(t, "\\$&"), i) t_form_phonemask__searchCountry(e, "^" + s, p, o, i[o].n);
    ...
    t_form_phonemask__changeVal(t, p), e.addEventListener("click", function () {
        o.classList.contains("t-input-phonemask__options-wrap_open") ? r() : (r(), o.classList.add("t-input-phonemask__options-wrap_open")), 1 === a.length && (a[0].style.overflow = "unset")
    }), p.addEventListener("input", function () {
        var n = this, e = n.value;
    ...
    }), document.addEventListener("mouseup", x), document.addEventListener("keyup", l), document.querySelector('[data-init-mask="yes"]') || (document.addEventListener("mouseup", x), document.addEventListener("keyup", l))
}

function t_form_phonemask__copypasteHandling(n, e) {
    var t = n.value, a = t.match(/[0-9]/g) ? t.match(/[0-9]/g) : t;
...
function t_form_phonemask__addNumberMask(n, e) {
    var t = e.getAttribute("data-phonemask-code"), t = e.getAttribute("data-phonemask-mask").substr(t.length),
        n = n.match(/\d+/g), a = (n = n ? n.join("") : "").split(""), p = t.match(/(\+|\d+|[\s()-]|9+)/g), o = "";
    if (p) {
...
function t_form_phonemask__changeVal(n, e) {
    e.value && (n.querySelector(".js-phonemask-result").value = e.getAttribute("data-phonemask-code") + " " + e.value)
}

function t_form_phonemask__chooseCountry(n, e) {
    var t = n.querySelector(".t-input-phonemask"), a = n.querySelector(".t-input-phonemask__select-code"),
        p = n.querySelector(".t-input-phonemask__select-flag"), o = e.getAttribute("data-phonemask-code"),
        i = e.getAttribute("data-phonemask-mask"), s = e.getAttribute("data-phonemask-country-code"),
...
function t_form_phonemask__searchCountry(n, e, t, a, p) {
    e = new RegExp(e, "i");
    -1 !== p.search(e) && (t.push(n.querySelector("#t-phonemask_" + a)), t[0].classList.add("t-input-phonemask__options-item_chosen"), e = n.querySelector(".t-input-phonemask__options-item_chosen").getBoundingClientRect().top, a = n.getBoundingClientRect().top, t = document.body.scrollTop + n.scrollTop, n.scrollTop = e - a + t)
}

function t_form_phonemask__changeMinLength(n, e, t) {
    var a, p, o = 1;
    n && e && (p = t.querySelector(".t-input-phonemask"), a = t.querySelector(".js-phonemask-result"), p = p.getAttribute("data-phonemask-code"), o = e.length + 1 + n.length - ({
        "+49": 1,
        "+372": 1,
        "+355": 1,
        "+213": 1,
...
function t_form_phonemask__addStyle() {
    ...
    }), document.head.insertAdjacentHTML("beforeend", '<style class="t-phonemask-style">' + e + "</style>");
    var n = document.querySelectorAll(".t-input-phonemask__wrap");
    Array.prototype.forEach.call(n, function (n) {
        n.classList.add("t-input-phonemask__wrap-style")
    })
}
...
function t_form_phonemask__getCountriesList() {
    return {
        ...
        id: {n: "Indonesia", c: "+62", m: "+62(999) 999-99-999"},
        ...
        my: {n: "Malaysia", c: "+60", m: "+60-99-999-9999"},
        ...
        mu: {n: "Mauritius (Moris)", c: "+230", m: "+230-999-9999"},
        ...
        mz: {n: "Mozambique (Moçambique)", c: "+258", m: "+258-99-999-999"},
        ...
        np: {n: "Nepal (नेपाल)", c: "+977", m: "+977-99-999-999"},
        nl: {n: "Netherlands (Nederland)", c: "+31", m: "+31-99-999-9999"},
        nz: {n: "New Zealand", c: "+64", m: "+64(999) 999-999"},
        ...
        so: {n: "Somalia (Soomaaliya)", c: "+252", m: "+252-99-999-999"},
        ...
        tr: {n: "Turkey (Türkiye)", c: "+90", m: "+90(999) 999-99999"},
