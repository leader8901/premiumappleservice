...
function t_animate__checkMobile(t) {
    return t.filter(function () {
        return "y" === $(this).closest(".t396__elem").attr("data-animate-mobile") || ($(this).removeClass("t-animate"), !1)
    }), t
}
...
function t_animate__animateChainItemsOnScroll(t, a, e) {
    var n = $(t[a]), i = n.find(".t-animate_wait[data-animate-chain=yes]"), s = 0, r = 0, o = t[a].itemsOffsets[0],
        _ = t_animate__getDelayFromPreviousScrollEvent(n, i, .16), m = t_animate__getSectionHeadDealy(n);
    ...
    t.each(function () {
        ...
        if (n = n.split(";").filter(function (t, a) {
            ...
            if (-1 === e.indexOf(r) && (o = r = r.split(" ")[0]), "" !== r) {
                var _;
                if (t.attr("data-animate-number-count", e), null !== s) if (-1 !== r.indexOf(",") && (_ = r.split(",")), -1 !== r.indexOf(".") && (_ = r.split(".")), -1 !== r.indexOf(",") || -1 !== r.indexOf(".")) {
                    var m = _[1].length;
...
function t_animate__animateNumbers(t) {
    t.each(function () {
        ...
        if (t.find("span:not(.t-animate__number):first").each(function () {
            ...
            var n = a.match(/\d+\.\d+|\d+,\d+/g), i = a.match(/\d+/g), s = [];
            ...
            t.find(".t-animate__number").each(function () {
                ...
                void 0 !== _[s] && $({animateCounter: _[s]}).animate({animateCounter: n}, {
                    ...
                    easing: "swing",
                    step: function (a) {
                        var e, _ = t.find(".t-animate__number")[s], m = Math.pow(10, r);
...
function t_animate__setAnimationState(t, a, e) {
    var n = $(window).scrollTop(), i = n + $(window).height();
    t.each(function () {
        var t = $(this), a = t.find(".t-animate:not([data-animate-chain=yes])");
...
function t_animate__assignGroupDelay(t, a) {
    ...
    if (t.find("[data-animate-order]").length) t_animate__assignOrderedElemsDelay(t, a); else {
        var n = t.find(".t-img.t-animate"), i = t.find(".t-uptitle.t-animate"),
            ...
            o = t.find(".t-btn.t-animate:not(.t-section__bottomwrapper .t-btn)"), _ = t.find(".t-timer.t-animate"),
...
function t_animate__assignOrderedElemsDelay(t, a) {
    ...
    var n = t.find(".t-animate[data-animate-order=1]"), i = t.find(".t-animate[data-animate-order=2]"),
        ...
        o = t.find(".t-animate[data-animate-order=5]"), _ = t.find(".t-animate[data-animate-order=6]"),
        m = t.find(".t-animate[data-animate-order=7]"), d = t.find(".t-animate[data-animate-order=8]"),
...
function t_animate__getElemsOffsets(t) {
    for (var a = 0; a < t.length; a++) t[a].curTopOffset = $(window).scrollTop() + t[a].getBoundingClientRect().top
}
